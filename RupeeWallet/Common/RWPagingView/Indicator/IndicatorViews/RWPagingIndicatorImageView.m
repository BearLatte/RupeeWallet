//
//  RWPagingIndicatorImageView.m
//  RupeeWallet
//
//  Created by Tim on 2023/7/15.
//

#import "RWPagingIndicatorImageView.h"
#import "RWPagingFactory.h"

@implementation RWPagingIndicatorImageView
...
- (void)rw_selectedCell:(RWPagingIndicatorParamsModel *)model {
    ...
    if (self.isScrollEnabled) {
        ...
        if (self.indicatorImageViewRollEnabled && (model.selectedType == RWPagingCellSelectedTypeCode || model.selectedType == RWPagingCellSelectedTypeClick)) {
