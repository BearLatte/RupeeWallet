//
//  RWPagingIndicatorTriangleView.m
//  RupeeWallet
//
//  Created by Tim on 2023/7/15.
//

#import "RWPagingIndicatorTriangleView.h"
#import "RWPagingFactory.h"

@interface RWPagingIndicatorTriangleView()
@property (nonatomic, strong) CAShapeLayer *triangleLayer;
@end

@implementation RWPagingIndicatorTriangleView
...
- (void)rw_refreshState:(RWPagingIndicatorParamsModel *)model {
    ...
    if (self.componentPosition == RWPagingComponentPosition_Bottom) {
