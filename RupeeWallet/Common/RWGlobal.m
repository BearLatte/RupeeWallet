...
NSNotificationName _Nullable const AUTHENFICATION_FINISHED_NOTIFICATION = @"kAUTHENFICATION_FINISHED_NOTIFICATION";
...
NSString * const APP_STORE_TEST_ACCOUNT = @"8800203373";
